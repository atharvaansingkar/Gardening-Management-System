...
<body>
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <button><a href="add_flower.php">ADD</a></button>
            <button><a href="delete5.php">DELETE</a></button>
            <button><a href="select_flower.php">COMMENTS</a></button>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<form action='new5.php' method='POST'>";
