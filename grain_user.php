...
<div class="container-xxl py-5">
        ...
        <div class="row g-4">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<form action='new4_user.php' method='POST'>";
    ...
    <div class="container mx-auto p-4">
        <form method="post" action="process_form4.php">
            <div class="mb-4">
            ...
            <div class="mb-4">
                <label for="grainname" class="block text-gray-600 font-bold">Grain Name:</label>
