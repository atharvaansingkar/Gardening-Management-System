...
<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $table=$_POST['vegetable_T'];
        $name = $_POST['vegetable_name'];
        ...
        $sql = "DELETE FROM vegetables WHERE vegetable_name = $name";

        if (mysqli_query($conn, $sql)) {
            echo "Vegetable names $name has been deleted successfully.";
        } else {
