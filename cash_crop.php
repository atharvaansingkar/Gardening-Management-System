    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="mb-3">Cash Crops</h1>
                <!-- <p>Eirmod sed ipsum dolor sit rebum labore magna erat. Tempor ut dolore lorem kasd vero ipsum sit eirmod sit. Ipsum diam justo sed rebum vero dolor duo.</p> -->
            </div>
            <button><a href="add_crop.php">ADD</a></button>
            <button><a href="delete.php">DELETE</a></button>
            <button><a href="select_cash.php">COMMENTS</a></button>
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<img class='img-fluid' src='/img/cash.jpg' alt='Icon'>";
                    echo "</div>";

                    echo "<form action='new.php' method='POST'>";
                    echo "<input type='hidden' name='crop_name' value='" . $row['crop_name'] . "'>";
                    echo "<input type='submit' name='submit' value='" . $row['crop_name'] . "'></input>";
                    echo "</form>";
