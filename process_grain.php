...
if (isset($_POST['grainname'])) {
    ...
    if ($stmt) {
          ...
          echo "<div class='lg:w-4/5 mx-auto flex flex-wrap'>";
            echo "<div class='lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0'>";
                ...
                echo" <div class='flex border-t border-gray-200 py-2'>";
                 echo "<span class='text-gray-500'>Grain Name</span>";
                  echo"<span class='ml-32 text-gray-900'>".$row["grainname"]."</span>";
               echo" </div>";
               echo" <div class='flex border-t border-gray-200 py-2'>";
      ...
      echo "</section>";
            ...
            echo "No data found for grain: $name";
        }
