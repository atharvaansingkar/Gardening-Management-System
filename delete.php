<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql = "DELETE FROM cash_crops WHERE crop_name = ?";
        ...
        if ($stmt) {
            ...
            if (mysqli_stmt_execute($stmt)) {
                echo "Crop name '$name' has been deleted successfully.";
            } else {
...
<body class="bg-gray-100">
    <div class="container mx-auto p-4">
        <h1 class="text-2xl font-bold mb-4">Delete Crop</h1>
        <form method="POST" action="#" class="bg-white p-4 rounded-md shadow-md">
            <div class="md:flex md:space-x-4">
                <div class="md:w-1/2">
                    <input class="w-full px-3 py-2 border rounded" type="text" name="name" placeholder="Crop name">
                </div>
                <div class="md:w-1/2">
